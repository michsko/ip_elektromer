    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Aktivní', 'Aktivní'), ('Pozastavené', 'Pozastavené'), ('Neaktivní', 'Neaktivní')], max_length=150, null=True)),
        ...
        migrations.AddField(
            model_name='customer',
            name='svj',
            field=models.ManyToManyField(related_name='customers', to='elektromer_app.svj'),
        ),
        migrations.CreateModel(
            name='Chairman',
            fields=[
